...
return(
        <div class="flex items-center space-x-10 w-2/3" onChange={calculatePrice(count,data.price)}>
            ...
            <button class=" flex flex-1 justify-center ml-auto py-5 px-4 xl:px-16 font-Kumbh font-semibold  rounded-2xl bg-yellow-500 text-white shadow-md hover:bg-yellow-300 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:ring-opacity-75" 
