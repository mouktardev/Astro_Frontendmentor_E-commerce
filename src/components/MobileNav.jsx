...
function MobileNav(){
   ...
   useEffect(() => {
       const menue = gsap.utils.toArray(animation.current.map(el=>{return el.base ? el.base:el }));
       if(isOpen){
            gsap.to(menue,{xPercent:0})
            gsap.to(overlay,{opacity:0.5,pointerEvents:"auto"})
        }else{
            gsap.to(menue,{xPercent:-100})
        ...
        <>
            ...
            <div class="fixed z-30 left-0 top-0 bottom-0 w-60 bg-white dark:bg-gray-600" ref={addRef}>
                <ul class="flex items-start pl-6 pt-6 flex-col space-y-8">
                    ...
                    <li><a href="#" class="font-Kumbh font-medium text-xl text-gray-600 dark:text-white hover:text-gray-900 hover:font-semibold">Collections</a></li>
                    <li><a href="#" class="font-Kumbh font-medium text-xl text-gray-600 dark:text-white hover:text-gray-900 hover:font-semibold">Men</a></li>
                    <li><a href="#" class="font-Kumbh font-medium text-xl text-gray-600 dark:text-white hover:text-gray-900 hover:font-semibold">Women</a></li>
                    <li><a href="#" class="font-Kumbh font-medium text-xl text-gray-600 dark:text-white hover:text-gray-900 hover:font-semibold">About</a></li>
                    <li><a href="#" class="font-Kumbh font-medium text-xl text-gray-600 dark:text-white hover:text-gray-900 hover:font-semibold">Contact</a></li>
                    <ThemeToggle/>  
                </ul>
            </div>
